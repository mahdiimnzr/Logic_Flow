...
const ThemeSlide = ({ className, theme, setTheme }) => {
  return (
    <div
      ...
      className={`rounded-[50px] border relative ${!theme ? `bg-[#E0E0E0] border-star-yellow` : `bg-moon-background border-[#37474F]`} flex items-center justify-between w-16 h-7 px-1 cursor-pointer ${className}`}
    >
