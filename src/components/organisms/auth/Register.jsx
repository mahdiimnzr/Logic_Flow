...
const Register = () => {
  ...
  return (
    <div className=" border w-full flex flex-col md:flex-row-reverse items-center p-4 justify-end xl:gap-24 lg:gap-20 md:gap-15 gap-3">
      <div className={`h-full md:w-4/10 w-full flex flex-col justify-between`}>
        {page === "Step1" && <Registration setPage={setPage} />}
        {page === "Step2" && <RegisterCode />}
      </div>
      <div
      ...
      >
        ...
        />
        <img
          src={page == "Step1" ? loginStep1 : loginStep2}
